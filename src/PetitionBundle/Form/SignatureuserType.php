...
class SignatureuserType extends AbstractType
{ /**
 * {@inheritdoc}
 */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
      ...
      "pontoise"=> "pontoise"
            ...
            ->add('engagement', CheckboxType::class, array('required' => true, 'data' => true, 'value' => '1'))
            ->add('annonyme', CheckboxType::class, array('required' => false, 'data' => true,'value' => '1', 'label' => "Signature publique"));
